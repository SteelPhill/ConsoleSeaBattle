...
void main()
{
	...
	do
	{
		...
		isProgramContinue = TryContinueSelectedInMainMenu(isNewGame, gameMode, difficulty, firstPlayerField,
			secondPlayerField, firstPlayerLastShot, secondPlayerLastShot, firstPlayerData, secondPlayerData);

		if (!isProgramContinue)
			return;

		GameCourseInSelectedMode(isNewGame, gameMode, difficulty, firstPlayerField, secondPlayerField,
