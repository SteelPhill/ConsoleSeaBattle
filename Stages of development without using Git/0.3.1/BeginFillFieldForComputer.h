...
inline bool IsPossibleToPlaceHorizontalShip(char field[Rows][Columns], const int shipSize, const ShootResult& startCoordinate)
{
...
inline void GetStartPointsForHorizontalShip(char field[Rows][Columns], const int shipSize, ShootResult& startCoordinate)
{
...
inline bool IsPossibleToPlaceVerticalShip(char field[Rows][Columns], const int shipSize, const ShootResult& startCoordinate)
{
...
inline void GetStartPointsForVerticalShip(char field[Rows][Columns], const int shipSize, ShootResult& startCoordinate)
{
	const int BeginRange = 1;
	const int EndRange = 10;
...
inline void PlacementHorizontalShip(char field[Rows][Columns], const int shipSize, const ShootResult& startCoordinate)
{
...
inline void PlacementVerticalShip(char playField[Rows][Columns], const int shipSize, const ShootResult& startCoordinate)
{
