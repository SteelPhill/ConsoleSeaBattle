	...
	PlayerData& secondPlayerData)
{
	...
	case ModeMenuItems::PlayerVsAI:
	{
		...
		isProgramContinue = TryContinueSelectedInDifficultyMenu(
			gameMode, difficulty, firstPlayerData, secondPlayerData);
	...
	PlayerData& secondPlayerData)
{
	...
	do
	{
		...
		{
			isProgramContinue = TryContinueSelectedInModesMenu(
				gameMode, difficulty, firstPlayerData, secondPlayerData);
