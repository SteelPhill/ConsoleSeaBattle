...
void SetRandomCoordinatesForShot(char field[Rows][Columns], Cell& shot)
{
	...
	do
	{
		shot.coordinates.abscissa = rand() % (endCoordinateRange - 
			beginCoordinateRange + 1) + beginCoordinateRange;
		shot.coordinates.ordinate = rand() % (endCoordinateRange - 
			beginCoordinateRange + 1) + beginCoordinateRange;
...
void TrySecondHit(char field[Rows][Columns], Cell& shot)
{
	...
	do
	{
		secondHitDirection = (SecondHitDirection)(rand() % (endRangeOfDirectionOptions - 
			beginRangeOfDirectionOptions + 1) + beginRangeOfDirectionOptions);
