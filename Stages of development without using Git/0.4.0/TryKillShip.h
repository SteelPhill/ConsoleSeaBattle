...
inline void OneDeckKilled(char field[Rows][Columns], const Cell& hit)
{
...
inline int GetIndexBeforeFrontHorizontalShip(char field[Rows][Columns], const Cell& hit)
{
...
inline int GetIndexBeforeFrontVerticalShip(char field[Rows][Columns], const Cell& hit)
{
...
inline void KillHorizontalShip(char field[Rows][Columns], const Cell& hit)
{
...
inline void KillVerticalShip(char field[Rows][Columns], const Cell& hit)
{
...
inline bool IsShipDefinitelyNotKilled(char field[Rows][Columns], const Cell& hit)
{
...
inline bool IsNoMoreHitsAround(char field[Rows][Columns], const Cell& hit)
{
...
inline bool IsHorizontalShipKilled(char field[Rows][Columns], const Cell& hit)
{
...
inline bool IsVerticalShipKilled(char field[Rows][Columns], const Cell& hit)
{
...
inline bool IsShipKilled(char field[Rows][Columns], const Cell& hit)
{
