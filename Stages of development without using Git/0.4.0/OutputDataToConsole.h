...
inline void PrintShootCoordinates(const Cell& shot)
{
...
inline void PrintShotResult(const Cell& shot)
{
...
inline void PrintRowFromOneFieldWithShips(char field[Rows][Columns], const int rowNumber)
{
	if (rowNumber == 10)
		cout << rowNumber;
	else
...
inline void PrintRowFromOneFieldWithoutShips(char field[Rows][Columns], const int rowNumber)
{
	if (rowNumber == 10)
		cout << rowNumber;
	else
...
inline void PrintAiVsAiBattlefield(char firstAiField[Rows][Columns], char secondAiField[Rows][Columns], const string& firstAiName, const string& secondAiName, const Cell& shot)
{
	cout << endl;
...
inline void PrintPlayerVsAiBattlefield(char aiField[Rows][Columns], char playerField[Rows][Columns], const string& playerName, const string& aiName, const Cell& shot)
{
	cout << endl;
...
inline void PrintFieldForShot(char field[Rows][Columns])
{
...
inline void PrintFieldForPlacement(char field[Rows][Columns])
{
	PrintCoordinateLetters();
	cout << endl;
