...
inline bool IsPossibleToPlaceHorizontalShip(char field[Rows][Columns], const int shipSize, const Cell& startCell)
{
...
inline bool IsPossibleToPlaceVerticalShip(char field[Rows][Columns], const int shipSize, const Cell& startCell)
{
...
inline void PlacementHorizontalShip(char field[Rows][Columns], const int shipSize, const Cell& startCell)
{
...
inline void PlacementVerticalShip(char playField[Rows][Columns], const int shipSize, const Cell& startCell)
{
...
inline void AutoGetStartPointsForHorizontalShip(char field[Rows][Columns], const int shipSize, Cell& startCell)
{
...
inline void AutoGetStartPointsForVerticalShip(char field[Rows][Columns], const int shipSize, Cell& startCell)
{
	const int BeginRange = 1;
	const int EndRange = 10;
