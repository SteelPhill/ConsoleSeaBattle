	...
	PlayerData& secondPlayerData)
{
	...
	case ModeMenuItems::PlayerVsAI:
	{
		...
		isProgramContinue = TryChoiceDifficulty(gameMode, difficulty, firstPlayerData, secondPlayerData);
		break;
	}
	...
	PlayerData& secondPlayerData)
{
	...
	do
	{
		...
		{
			isProgramContinue = TryChoiceMode(gameMode, difficulty, firstPlayerData, secondPlayerData);
