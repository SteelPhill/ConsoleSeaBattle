...
inline void OneDeckKilled(char field[Rows][Columns], const ShotResult& hit)
{
...
inline int GetIndexBeforeFrontHorizontalShip(char field[Rows][Columns], const ShotResult& hit)
{
	int index = hit.x - 1;
...
inline int GetIndexBeforeFrontVerticalShip(char field[Rows][Columns], const ShotResult& hit)
{
	int index = hit.y - 1;
...
inline void KillHorizontalShip(char field[Rows][Columns], const ShotResult& hit)
{
...
inline void KillVerticalShip(char field[Rows][Columns], const ShotResult& hit)
{
...
inline bool IsShipKilled(char field[Rows][Columns], const ShotResult& hit)
{
