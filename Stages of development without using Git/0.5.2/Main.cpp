	...
	do
	{
		...
		case MainMenuItems::NewGame:
		{
			...
			case ModeMenuItems::PlayerVsAI:
			{
				...
				{
					PlayerVsAIMode(isNewGame, gameMode, difficulty, firstPlayerField, secondPlayerField, firstPlayerLastShot, secondPlayerLastShot, firstPlayerName, secondPlayerName);
					break;
				}
			...
			case ModeMenuItems::AIVsAI:
			{
				...
				case DifficultySelectionMenuItems::Easy:
				{
					AIVsAIMode(isNewGame, gameMode, difficulty, firstPlayerField, secondPlayerField, firstPlayerLastShot, secondPlayerLastShot, firstPlayerName, secondPlayerName);
					break;
				}
				case DifficultySelectionMenuItems::Hard:
				{
