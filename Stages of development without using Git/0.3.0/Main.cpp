...
void EasyComputerVsEasyComputer()
{
	...
	for (int i = 1; ; i++)
	{
		...
		do
		{
			...
			isHit = IsShootEasyComputerHit(fieldComputer2);
		...
		do
		{
			...
			isHit = IsShootEasyComputerHit(fieldComputer1);
...
void HardComputerVsHardComputer()
{
	...
	for (int i = 1; ; i++)
	{
		...
		do
		{
			...
			shootComputer1 = IsShootHardComputerHit(fieldComputer2, shootComputer1);
		...
		do
		{
			...
			shootComputer2 = IsShootHardComputerHit(fieldComputer1, shootComputer2);
