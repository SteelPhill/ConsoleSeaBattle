	...
	PlayerData& secondPlayerData)
{
	...
	case DifficultySelectionMenuItems::Easy:
	{
		...
		if (gameMode == ModeMenuItems::PlayerVsAI)
			isProgramContinue = TryChoiceMovesOrder(firstPlayerData, secondPlayerData);
		break;
	}
	...
	PlayerData& secondPlayerData)
{
	...
	case ModeMenuItems::PlayerVsAI:
	{
		...
		isProgramContinue = TryChoiceDifficulty(isNewGame, gameMode, difficulty, firstPlayerField, secondPlayerField, firstPlayerLastShot, secondPlayerLastShot, firstPlayerData, secondPlayerData);
		break;
	}
	case ModeMenuItems::AIVsAI:
	{
		...
		secondPlayerData.isPlayer = false;
		secondPlayerData.isFirstAI = false;
		TryChoiceDifficulty(isNewGame, gameMode, difficulty, firstPlayerField, secondPlayerField, firstPlayerLastShot, secondPlayerLastShot, firstPlayerData, secondPlayerData);
		break;
	}
