	...
	PlayerData& secondPlayerData)
{
	...
	do
	{
		isGameOver = !IsMove(gameMode, difficulty, secondPlayerField, firstPlayerField, secondPlayerShot, firstPlayerShot, secondPlayerName, firstPlayerName, secondPlayerData, firstPlayerData);
		if (isGameOver)
			return;

		isGameOver = !IsMove(gameMode, difficulty, firstPlayerField, secondPlayerField, firstPlayerShot, secondPlayerShot, firstPlayerName, secondPlayerName, firstPlayerData, secondPlayerData);
		if (isGameOver)
			return;
