...
MenuForChoosingMovesOrderItems MenuForChoosingMovesOrder()
{
	const int BeginRange = 0;
	const int EndRange = 2;

	MenuForChoosingMovesOrderItems choice;
	...
	cout << "Выберите номер пункта и нажмите Enter" << endl;
	cout << " => ";
	choice = (MenuForChoosingMovesOrderItems)CinValueInRange(BeginRange, EndRange);
